 ...
 * @subpackage 	Siscomex
 */
class SiscomexViewSiscomexnbm extends JViewLegacy
{
	/**
	...
	function display($tpl = null){
		...
		JToolBarHelper::title(   JText::_( 'COM_SISCOMEX_MENU_SISCOMEXNBMLIST' ).': <span>[ ' . $text.' ]</span>' );
		
		if ($isNew)  {
			if($user->authorise('core.create', 'com_siscomex')){
				JToolBarHelper::apply('siscomexnbm.apply');
				JToolBarHelper::save('siscomexnbm.save');
			}
			JToolBarHelper::cancel('siscomexnbm.cancel');
		} else {
			...
			JToolBarHelper::cancel( 'siscomexnbm.cancel', 'JTOOLBAR_CLOSE' );
		}
