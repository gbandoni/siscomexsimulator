 ...
 * @subpackage 	Siscomex
 */
class SiscomexViewSiscomexdi extends JViewLegacy
{
	/**
	...
	function display($tpl = null){
		...
		JToolBarHelper::title(   JText::_( 'COM_SISCOMEX_MENU_SISCOMEXDILIST' ).': <span>[ ' . $text.' ]</span>' );
		
		if ($isNew)  {
			if($user->authorise('core.create', 'com_siscomex')){
				JToolBarHelper::apply('siscomexdi.apply');
				JToolBarHelper::save('siscomexdi.save');
			}
			JToolBarHelper::cancel('siscomexdi.cancel');
		} else {
			...
			JToolBarHelper::cancel( 'siscomexdi.cancel', 'JTOOLBAR_CLOSE' );
		}
