 ...
 * @subpackage 	Siscomex
 */
class SiscomexViewSiscomexfundlegal extends JViewLegacy
{
	/**
	...
	function display($tpl = null){
		...
		JToolBarHelper::title(   JText::_( 'COM_SISCOMEX_MENU_SISCOMEXFUNDLEGALLIST' ).': <span>[ ' . $text.' ]</span>' );
		
		if ($isNew)  {
			if($user->authorise('core.create', 'com_siscomex')){
				JToolBarHelper::apply('siscomexfundlegal.apply');
				JToolBarHelper::save('siscomexfundlegal.save');
			}
			JToolBarHelper::cancel('siscomexfundlegal.cancel');
		} else {
			...
			JToolBarHelper::cancel( 'siscomexfundlegal.cancel', 'JTOOLBAR_CLOSE' );
		}
