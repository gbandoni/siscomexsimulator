 ...
 * @subpackage 	Siscomex
 */
class SiscomexViewSiscomexlocalidadeembarque extends JViewLegacy
{
	/**
	...
	function display($tpl = null){
		...
		JToolBarHelper::title(   JText::_( 'COM_SISCOMEX_MENU_SISCOMEXLOCALIDADEEMBARQUELIST' ).': <span>[ ' . $text.' ]</span>' );
		
		if ($isNew)  {
			if($user->authorise('core.create', 'com_siscomex')){
				JToolBarHelper::apply('siscomexlocalidadeembarque.apply');
				JToolBarHelper::save('siscomexlocalidadeembarque.save');
			}
			JToolBarHelper::cancel('siscomexlocalidadeembarque.cancel');
		} else {
			...
			JToolBarHelper::cancel( 'siscomexlocalidadeembarque.cancel', 'JTOOLBAR_CLOSE' );
		}
