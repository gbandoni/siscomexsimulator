<?php
/**
 * SiscomextipodocumentoAerea Form Field List class for the Siscomex component
 * 
 * @package    Siscomex
...
class JFormFieldSiscomextipodocumentoAerea extends JFormFieldList{
	/**
	 * The field type.
	 *
	 * @var		string
	 */
	protected $type = 'SiscomextipodocumentoAerea';
