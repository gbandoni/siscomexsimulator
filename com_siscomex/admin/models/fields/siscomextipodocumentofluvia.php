<?php
/**
 * SiscomextipodocumentoFluvia Form Field List class for the Siscomex component
 * 
 * @package    Siscomex
...
class JFormFieldSiscomextipodocumentoFluvia extends JFormFieldList{
	/**
	 * The field type.
	 *
	 * @var		string
	 */
	protected $type = 'SiscomextipodocumentoFluvia';
