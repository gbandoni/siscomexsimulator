<?php
/**
 * SiscomexcidadesEstado Form Field List class for the Siscomex component
 * 
 * @package    Siscomex
...
class JFormFieldSiscomexcidadesEstado extends JFormFieldList{
	/**
	 * The field type.
	 *
	 * @var		string
	 */
	protected $type = 'SiscomexcidadesEstado';
