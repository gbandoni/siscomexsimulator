<?php
/**
 * SiscomextipodocumentoPostal Form Field List class for the Siscomex component
 * 
 * @package    Siscomex
...
class JFormFieldSiscomextipodocumentoPostal extends JFormFieldList{
	/**
	 * The field type.
	 *
	 * @var		string
	 */
	protected $type = 'SiscomextipodocumentoPostal';
