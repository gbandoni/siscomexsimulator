 ...
 * @subpackage 	Siscomex
 */
class SiscomexModelSiscomexmercadoriaadi extends JModelAdmin{
	/**
	...
	protected function allowEdit($data = array(), $key = 'id')
	{
		...
		return JFactory::getUser()->authorise('core.edit', 'com_siscomex.siscomexmercadoriaadi.'.((int) isset($data[$key]) ? $data[$key] : 0)) or parent::allowEdit($data, $key);
	}
    ...
    protected function prepareTable($table){
        ...
        $nullable ='nomeunidademedidacomercializada,quantidademercadoriaunidadecomercializada,textodetalhamentomercadoria,valorunidadelocalembarque,valorunidademedidacondicaovenda';
		if(!$nullable) return;
	 ...
	 * @since	1.6
	 */
	public function getTable($type = 'Siscomexmercadoriaadi', $prefix = 'SiscomexTable', $config = array()) 
	{
	...
	{
		// Get the form.
		$form = $this->loadForm('com_siscomex.siscomexmercadoriaadi', 'siscomexmercadoriaadi', array('control' => 'jform', 'load_data' => $loadData));
		if (empty($form)) 
		{
			return false;
		}
	...
	{
		return 'administrator/components/com_siscomex/models/forms/siscomexmercadoriaadi.js';
	}
	...
	protected function loadFormData() 
	{
		...
		$data = JFactory::getApplication()->getUserState('com_siscomex.edit.siscomexmercadoriaadi.data', array());
		if (empty($data)) 
		{
			$data = $this->getItem();
		}
