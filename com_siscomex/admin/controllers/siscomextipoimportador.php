 ...
 * @subpackage 	Siscomex
 */
class SiscomexControllerSiscomextipoimportador extends JControllerForm{
	/**
	 ...
	 * @since  11.1
	 */
	protected $view_item = 'siscomextipoimportador';
	 ...
	 * @since  11.1
	 */
	protected $view_list = 'siscomextipoimportadorlist';	
