 ...
 * @subpackage 	Siscomex
 */
class SiscomexControllerSiscomextipodocumentodeslist extends JControllerAdmin{
	 ...
	 * @since	1.6
	 */
	public function getModel($name = 'Siscomextipodocumentodes', $prefix = 'SiscomexModel', $cfg = array('ignore_request' => true)){
