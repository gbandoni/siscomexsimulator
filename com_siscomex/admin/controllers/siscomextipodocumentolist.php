 ...
 * @subpackage 	Siscomex
 */
class SiscomexControllerSiscomextipodocumentolist extends JControllerAdmin{
	 ...
	 * @since	1.6
	 */
	public function getModel($name = 'Siscomextipodocumento', $prefix = 'SiscomexModel', $cfg = array('ignore_request' => true)){
