 ...
 * @subpackage 	Siscomex
 */
class SiscomexControllerSiscomextipodeclaracao extends JControllerForm{
	/**
	 ...
	 * @since  11.1
	 */
	protected $view_item = 'siscomextipodeclaracao';
	 ...
	 * @since  11.1
	 */
	protected $view_list = 'siscomextipodeclaracaolist';	
