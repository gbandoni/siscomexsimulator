 ...
 * @subpackage 	Siscomex
 */
class SiscomexControllerSiscomexcasoslist extends JControllerAdmin{
	 ...
	 * @since	1.6
	 */
	public function getModel($name = 'Siscomexcasos', $prefix = 'SiscomexModel', $cfg = array('ignore_request' => true)){
