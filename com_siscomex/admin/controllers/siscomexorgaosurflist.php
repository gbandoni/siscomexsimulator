 ...
 * @subpackage 	Siscomex
 */
class SiscomexControllerSiscomexorgaosurflist extends JControllerAdmin{
	 ...
	 * @since	1.6
	 */
	public function getModel($name = 'Siscomexorgaosurf', $prefix = 'SiscomexModel', $cfg = array('ignore_request' => true)){
