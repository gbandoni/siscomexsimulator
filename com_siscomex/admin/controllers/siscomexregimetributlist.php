 ...
 * @subpackage 	Siscomex
 */
class SiscomexControllerSiscomexregimetributlist extends JControllerAdmin{
	 ...
	 * @since	1.6
	 */
	public function getModel($name = 'Siscomexregimetribut', $prefix = 'SiscomexModel', $cfg = array('ignore_request' => true)){
