 ...
 * @subpackage 	Siscomex
 */
class SiscomexControllerSiscomextipoembalagem extends JControllerForm{
	/**
	 ...
	 * @since  11.1
	 */
	protected $view_item = 'siscomextipoembalagem';
	 ...
	 * @since  11.1
	 */
	protected $view_list = 'siscomextipoembalagemlist';	
