 ...
 * @subpackage 	Siscomex
 */
class SiscomexControllerSiscomexespecncmlist extends JControllerAdmin{
	 ...
	 * @since	1.6
	 */
	public function getModel($name = 'Siscomexespecncm', $prefix = 'SiscomexModel', $cfg = array('ignore_request' => true)){
