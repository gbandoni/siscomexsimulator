 ...
 * @subpackage 	Siscomex
 */
class SiscomexControllerSiscomexregimetribut extends JControllerForm{
	/**
	 ...
	 * @since  11.1
	 */
	protected $view_item = 'siscomexregimetribut';
	 ...
	 * @since  11.1
	 */
	protected $view_list = 'siscomexregimetributlist';	
