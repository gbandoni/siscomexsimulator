 ...
 * @subpackage 	Siscomex
 */
class SiscomexControllerSiscomexestadolist extends JControllerAdmin{
	 ...
	 * @since	1.6
	 */
	public function getModel($name = 'Siscomexestado', $prefix = 'SiscomexModel', $cfg = array('ignore_request' => true)){
