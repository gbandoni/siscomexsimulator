 ...
 * @subpackage 	Siscomex
 */
class SiscomexControllerSiscomexnaladinccalist extends JControllerAdmin{
	 ...
	 * @since	1.6
	 */
	public function getModel($name = 'Siscomexnaladincca', $prefix = 'SiscomexModel', $cfg = array('ignore_request' => true)){
