 ...
 * @subpackage 	Siscomex
 */
class SiscomexControllerSiscomextipoembalagemlist extends JControllerAdmin{
	 ...
	 * @since	1.6
	 */
	public function getModel($name = 'Siscomextipoembalagem', $prefix = 'SiscomexModel', $cfg = array('ignore_request' => true)){
