 ...
 * @subpackage 	Siscomex
 */
class SiscomexControllerSiscomexatribncmlist extends JControllerAdmin{
	 ...
	 * @since	1.6
	 */
	public function getModel($name = 'Siscomexatribncm', $prefix = 'SiscomexModel', $cfg = array('ignore_request' => true)){
