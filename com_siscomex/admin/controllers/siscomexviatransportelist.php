 ...
 * @subpackage 	Siscomex
 */
class SiscomexControllerSiscomexviatransportelist extends JControllerAdmin{
	 ...
	 * @since	1.6
	 */
	public function getModel($name = 'Siscomexviatransporte', $prefix = 'SiscomexModel', $cfg = array('ignore_request' => true)){
