 ...
 * @subpackage 	Siscomex
 */
class SiscomexControllerSiscomextipoimportadorlist extends JControllerAdmin{
	 ...
	 * @since	1.6
	 */
	public function getModel($name = 'Siscomextipoimportador', $prefix = 'SiscomexModel', $cfg = array('ignore_request' => true)){
