 ...
 * @subpackage 	Siscomex
 */
class SiscomexControllerSiscomexmercadoriaadi extends JControllerForm{
	/**
	 ...
	 * @since  11.1
	 */
	protected $view_item = 'siscomexmercadoriaadi';
	 ...
	 * @since  11.1
	 */
	protected $view_list = 'siscomexmercadoriaadilist';	
