 ...
 * @subpackage 	Siscomex
 */
class SiscomexControllerSiscomextipomanifestolist extends JControllerAdmin{
	 ...
	 * @since	1.6
	 */
	public function getModel($name = 'Siscomextipomanifesto', $prefix = 'SiscomexModel', $cfg = array('ignore_request' => true)){
