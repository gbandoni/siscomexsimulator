 ...
 * @subpackage 	Siscomex
 */
class SiscomexControllerSiscomextipomanifesto extends JControllerForm{
	/**
	 ...
	 * @since  11.1
	 */
	protected $view_item = 'siscomextipomanifesto';
	 ...
	 * @since  11.1
	 */
	protected $view_list = 'siscomextipomanifestolist';	
