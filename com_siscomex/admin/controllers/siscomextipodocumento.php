 ...
 * @subpackage 	Siscomex
 */
class SiscomexControllerSiscomextipodocumento extends JControllerForm{
	/**
	 ...
	 * @since  11.1
	 */
	protected $view_item = 'siscomextipodocumento';
	 ...
	 * @since  11.1
	 */
	protected $view_list = 'siscomextipodocumentolist';	
