 ...
 * @subpackage 	Siscomex
 */
class SiscomexControllerSiscomexacordoaladilist extends JControllerAdmin{
	 ...
	 * @since	1.6
	 */
	public function getModel($name = 'Siscomexacordoaladi', $prefix = 'SiscomexModel', $cfg = array('ignore_request' => true)){
