 ...
 * @subpackage 	Siscomex
 */
class SiscomexControllerSiscomexacrescimoslist extends JControllerAdmin{
	 ...
	 * @since	1.6
	 */
	public function getModel($name = 'Siscomexacrescimos', $prefix = 'SiscomexModel', $cfg = array('ignore_request' => true)){
