 ...
 * @subpackage 	Siscomex
 */
class SiscomexControllerSiscomexinstfinanceiralist extends JControllerAdmin{
	 ...
	 * @since	1.6
	 */
	public function getModel($name = 'Siscomexinstfinanceira', $prefix = 'SiscomexModel', $cfg = array('ignore_request' => true)){
