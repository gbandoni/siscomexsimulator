 ...
 * @subpackage 	Siscomex
 */
class SiscomexControllerSiscomexinstfinanceira extends JControllerForm{
	/**
	 ...
	 * @since  11.1
	 */
	protected $view_item = 'siscomexinstfinanceira';
	 ...
	 * @since  11.1
	 */
	protected $view_list = 'siscomexinstfinanceiralist';	
