 ...
 * @subpackage 	Siscomex
 */
class SiscomexControllerSiscomexncmlist extends JControllerAdmin{
	 ...
	 * @since	1.6
	 */
	public function getModel($name = 'Siscomexncm', $prefix = 'SiscomexModel', $cfg = array('ignore_request' => true)){
