 ...
 * @subpackage 	Siscomex
 */
class SiscomexControllerSiscomexpaiseslist extends JControllerAdmin{
	 ...
	 * @since	1.6
	 */
	public function getModel($name = 'Siscomexpaises', $prefix = 'SiscomexModel', $cfg = array('ignore_request' => true)){
