 ...
 * @subpackage 	Siscomex
 */
class SiscomexControllerSiscomexfundlegallist extends JControllerAdmin{
	 ...
	 * @since	1.6
	 */
	public function getModel($name = 'Siscomexfundlegal', $prefix = 'SiscomexModel', $cfg = array('ignore_request' => true)){
