 ...
 * @subpackage 	Siscomex
 */
class SiscomexControllerSiscomexincotermslist extends JControllerAdmin{
	 ...
	 * @since	1.6
	 */
	public function getModel($name = 'Siscomexincoterms', $prefix = 'SiscomexModel', $cfg = array('ignore_request' => true)){
