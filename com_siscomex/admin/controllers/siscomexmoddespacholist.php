 ...
 * @subpackage 	Siscomex
 */
class SiscomexControllerSiscomexmoddespacholist extends JControllerAdmin{
	 ...
	 * @since	1.6
	 */
	public function getModel($name = 'Siscomexmoddespacho', $prefix = 'SiscomexModel', $cfg = array('ignore_request' => true)){
