 ...
 * @subpackage 	Siscomex
 */
class SiscomexControllerSiscomexaladilist extends JControllerAdmin{
	 ...
	 * @since	1.6
	 */
	public function getModel($name = 'Siscomexaladi', $prefix = 'SiscomexModel', $cfg = array('ignore_request' => true)){
