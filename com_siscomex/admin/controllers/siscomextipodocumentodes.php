 ...
 * @subpackage 	Siscomex
 */
class SiscomexControllerSiscomextipodocumentodes extends JControllerForm{
	/**
	 ...
	 * @since  11.1
	 */
	protected $view_item = 'siscomextipodocumentodes';
	 ...
	 * @since  11.1
	 */
	protected $view_list = 'siscomextipodocumentodeslist';	
