 ...
 * @subpackage 	Siscomex
 */
class SiscomexControllerSiscomexbancoslist extends JControllerAdmin{
	 ...
	 * @since	1.6
	 */
	public function getModel($name = 'Siscomexbancos', $prefix = 'SiscomexModel', $cfg = array('ignore_request' => true)){
