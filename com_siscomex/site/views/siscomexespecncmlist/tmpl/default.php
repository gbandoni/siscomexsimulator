...
<!-- Joomla! Component Builder - begin code  -->
	<th class="jcb_fieldDiv jcb_fieldLabel">
		<?php echo JText::_( 'COM_SISCOMEX_SISCOMEXESPECNCM_NCM_LABEL' ); ?>
	</th>
	<th class="jcb_fieldDiv jcb_fieldLabel">
		<?php echo JText::_( 'COM_SISCOMEX_SISCOMEXESPECNCM_ATRIBUTO_LABEL' ); ?>
	</th>
	<th class="jcb_fieldDiv jcb_fieldLabel">
		<?php echo JText::_( 'COM_SISCOMEX_SISCOMEXESPECNCM_ESPECIFICACAO_LABEL' ); ?>
	</th>
	<th class="jcb_fieldDiv jcb_fieldLabel">
		<?php echo JText::_( 'COM_SISCOMEX_SISCOMEXESPECNCM_NIVEL_LABEL' ); ?>
	</th>
	<th class="jcb_fieldDiv jcb_fieldLabel">
		<?php echo JText::_( 'COM_SISCOMEX_SISCOMEXESPECNCM_DESCRICAO_LABEL' ); ?>
	</th>
...
<?php
	$link = JRoute::_( "index.php?option=com_siscomex&view=siscomexespecncm&id={$dataItem->ncm}" );
?>
		<tr>
			<td>
...
<!-- Joomla! Component Builder - begin code  -->
	...
	<td class="jcb_fieldDiv jcb_fieldValue">
		<?php echo $dataItem->especificacao; ?>
	</td>
	<td class="jcb_fieldDiv jcb_fieldValue">
