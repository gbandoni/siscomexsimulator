...
<!-- Joomla! Component Builder - begin code  -->
	<th class="jcb_fieldDiv jcb_fieldLabel">
		<?php echo JText::_( 'COM_SISCOMEX_SISCOMEXINSTFINANCEIRA_CODIGO_LABEL' ); ?>
	</th>
	<th class="jcb_fieldDiv jcb_fieldLabel">
		<?php echo JText::_( 'COM_SISCOMEX_SISCOMEXINSTFINANCEIRA_DESCRICAO_LABEL' ); ?>
	</th>
...
<?php
	$link = JRoute::_( "index.php?option=com_siscomex&view=siscomexinstfinanceira&id={$dataItem->codigo}" );
?>
		<tr>
			<td>
