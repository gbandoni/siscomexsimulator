...
<!-- Joomla! Component Builder - begin code  -->
	<th class="jcb_fieldDiv jcb_fieldLabel">
		<?php echo JText::_( 'COM_SISCOMEX_SISCOMEXLOCALIDADEEMBARQUE_ID_LABEL' ); ?>
	</th>
	<th class="jcb_fieldDiv jcb_fieldLabel">
		<?php echo JText::_( 'COM_SISCOMEX_SISCOMEXLOCALIDADEEMBARQUE_CODPAIS_LABEL' ); ?>
	</th>
	<th class="jcb_fieldDiv jcb_fieldLabel">
		<?php echo JText::_( 'COM_SISCOMEX_SISCOMEXLOCALIDADEEMBARQUE_LOCALIDADE_LABEL' ); ?>
	</th>
...
<?php
	$link = JRoute::_( "index.php?option=com_siscomex&view=siscomexlocalidadeembarque&id={$dataItem->ID}" );
?>
		<tr>
			<td>
...
<!-- Joomla! Component Builder - begin code  -->
	...
	<td class="jcb_fieldDiv jcb_fieldValue">
		<?php echo $dataItem->codpais; ?>
	</td>
	<td class="jcb_fieldDiv jcb_fieldValue">
		<?php echo $dataItem->localidade; ?>
	</td>
