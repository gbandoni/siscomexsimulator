...
<!-- Joomla! Component Builder - begin code  -->
	<th class="jcb_fieldDiv jcb_fieldLabel">
		<?php echo JText::_( 'COM_SISCOMEX_SISCOMEXALADI_CODIGO_LABEL' ); ?>
	</th>
	<th class="jcb_fieldDiv jcb_fieldLabel">
		<?php echo JText::_( 'COM_SISCOMEX_SISCOMEXALADI_DESCRICAO_LABEL' ); ?>
	</th>
...
<?php
	$link = JRoute::_( "index.php?option=com_siscomex&view=siscomexaladi&id={$dataItem->codigo}" );
?>
		<tr>
			<td>
