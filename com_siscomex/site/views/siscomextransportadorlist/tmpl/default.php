...
<!-- Joomla! Component Builder - begin code  -->
	<th class="jcb_fieldDiv jcb_fieldLabel">
		<?php echo JText::_( 'COM_SISCOMEX_SISCOMEXTRANSPORTADOR_ID_LABEL' ); ?>
	</th>
	<th class="jcb_fieldDiv jcb_fieldLabel">
		<?php echo JText::_( 'COM_SISCOMEX_SISCOMEXTRANSPORTADOR_NOME_LABEL' ); ?>
	</th>
...
<?php
	$link = JRoute::_( "index.php?option=com_siscomex&view=siscomextransportador&id={$dataItem->id}" );
?>
		<tr>
			<td>
